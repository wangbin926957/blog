    ...
    <article>
        ...
        <div class="picsbox">
            <div class="banner">
                <div id="banner" class="fader">
                    <li class="slide" ><a href="/" target="_blank"><img src="{{ asset('images/banner01.jpg') }}"><span class="imginfo">别让这些闹心的套路，毁了你的网页设计!</span></a></li>
                    <li class="slide" ><a href="/" target="_blank"><img src="{{ asset('images/banner02.jpg') }}"><span class="imginfo">网页中图片属性固定宽度，如何用js改变大小</span></a></li>
                    <li class="slide" ><a href="/" target="_blank"><img src="{{ asset('images/banner03.jpg') }}"><span class="imginfo">个人博客，属于我的小世界！</span></a></li>
            ...
            <!--banner end-->
            <div class="toppic">
                <li> <a href="/" target="_blank"> <i><img src="{{ asset('images/toppic01.jpg') }}"></i>
                        <h2>别让这些闹心的套路，毁了你的网页设计!</h2>
                        <span>学无止境</span> </a> </li>
                <li> <a href="/" target="_blank"> <i><img src="{{ asset('images/zd01.jpg') }}"></i>
                        <h2>个人博客，属于我的小世界！</h2>
                        <span>学无止境</span> </a> </li>
            </div>
        </div>
        ...
        <div class="blogsbox">
            <div class="blogs" data-scroll-reveal="enter bottom over 1s" >
                ...
                <span class="blogpic"><a href="/" title=""><img src="{{ asset('images/toppic01.jpg') }}" alt=""></a></span>
      ...
      <li><img src="{{ asset('images/toppic02.jpg') }}" alt=""></li>
      <li><img src="{{ asset('images/banner01.jpg') }}" alt=""></li>
      </a></span>
                <p class="blogtext">如图，要实现上图效果，我采用如下方法：1、首先在数据库模型，增加字段，分别是图片2，图片3。2、增加标签模板，用if，else if 来判断，输出。思路已打开，样式调用就可以多样化啦！... </p>
                <div class="bloginfo">
                    <ul>
            ...
            <div class="blogs" data-scroll-reveal="enter bottom over 1s" >
                <h3 class="blogtitle"><a href="/" target="_blank">别让这些闹心的套路，毁了你的网页设计!</a></h3>
                <span class="bigpic"><a href="/" title=""><img src="{{ asset('images/toppic01.jpg') }}" alt=""></a></span>
                <p class="blogtext">如图，要实现上图效果，我采用如下方法：1、首先在数据库模型，增加字段，分别是图片2，图片3。2、增加标签模板，用if，else if 来判断，输出。思路已打开，样式调用就可以多样化啦！... </p>
                <div class="bloginfo">
                    <ul>
                        <li class="author"><a href="/">杨青</a></li>
            ...
            <div class="blogs" data-scroll-reveal="enter bottom over 1s" >
                ...
                <span class="bplist"><a href="/" title="">
      <li><img src="{{ asset('images/avatar.jpg') }}" alt=""></li>
      <li><img src="{{ asset('images/bi05.jpg') }}" alt=""></li>
      <li><img src="{{ asset('images/banner01.jpg') }}" alt=""></li>
      </a></span>
                <p class="blogtext">如图，要实现上图效果，我采用如下方法：1、首先在数据库模型，增加字段，分别是图片2，图片3。2、增加标签模板，用if，else if 来判断，输出。思路已打开，样式调用就可以多样化啦！... </p>
                <div class="bloginfo">
      ...
      <li><img src="{{ asset('images/banner01.jpg') }}" alt=""></li>
        ...
        <div class="sidebar">
            <div class="zhuanti">
                ...
                <ul>
                    <li> <i><img src="{{ asset('images/banner03.jpg') }}"></i>
                        <p>帝国cms调用方法 <span><a href="/">阅读</a></span> </p>
                    </li>
                    <li> <i><img src="{{ asset('images/b04.jpg') }}"></i>
                        <p>5.20 我想对你说 <span><a href="/">阅读</a></span></p>
                    </li>
                    <li> <i><img src="{{ asset('images/b05.jpg') }}"></i>
            ...
            <div class="tuijian">
                ...
                <ul class="tjpic">
                    <i><img src="{{ asset('images/toppic01.jpg') }}"></i>
                    <p><a href="/">别让这些闹心的套路，毁了你的网页设计</a></p>
                </ul>
                <ul class="sidenews">
                    <li> <i><img src="{{ asset('images/toppic01.jpg') }}"></i>
                        <p><a href="/">别让这些闹心的套路，毁了你的网页设计</a></p>
                        <span>2018-05-13</span> </li>
                    <li> <i><img src="{{ asset('images/toppic02.jpg') }}"></i>
                        <p><a href="/">给我模板PSD源文件，我给你设计HTML！</a></p>
                        <span>2018-05-13</span> </li>
                    <li> <i><img src="{{ asset('images/v1.jpg') }}"></i>
                        <p><a href="/">别让这些闹心的套路，毁了你的网页设计</a></p>
                        <span>2018-05-13</span> </li>
                    <li> <i><img src="{{ asset('images/v2.jpg') }}"></i>
                        <p><a href="/">给我模板PSD源文件，我给你设计HTML！</a></p>
                        <span>2018-05-13</span> </li>
                </ul>
            </div>
            ...
            <div class="guanzhu" id="follow-us">
                ...
                <ul>
                    ...
                    <li class="wx"><img src="{{ asset('images/wx.jpg') }}"></li>
                </ul>
            </div>
        </div>
    </article>
@endsection
@extends('client/common/footer')